...
class TestRQJob(FrappeTestCase):
    ...
    def test_get_list_filtering(self):
        ...
        non_failed_jobs = RQJob.get_list(
    ...
    def test_multi_queue_burst_consumption(self):
        ...
        _, stderr = execute_in_shell(
            "bench worker --queue short,default --burst", check_exit_code=True
        )
    ...
    def test_memory_usage(self):
        ...
        # Refer this PR: https://github.com/La-ah-Tech/frappe/pull/21467
    ...
    def test_clear_failed_jobs(self):
        ...
        self.assertLessEqual(
            RQJob.get_count({"filters": [["RQ Job", "status", "=", "failed"]]}),
            limit * 1.1,
        )
